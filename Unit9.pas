...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('TANGGAL BELUM DISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
     ShowMessage('ID CUSTOMER BELUM DIISI DENGAN BENAR');
    end else
    if e_4.text=''then
    begin
    ...
    if e_5.text=''then
    begin
     ShowMessage('ID KARYAWAN BELUM DIISI DENGAN BENAR');
    end else
    if e_6.text=''then
    begin
    ShowMessage('ID PEMESANAN BELUM SESUAI');
    end else
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update transaksi set id= "'+e_1.Text+'",tanggal="'+e_2.Text+'",customer_id="'+e_3.Text+'",no_telp="'+e_4.Text+'",karyawan_id="'+e_5.Text+'",pemesanan_id="'+e_6.Text+'" where id'+id+'"');
zqry1. ExecSQL;
