...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('ID BARANG BELUM DISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
    ...
    if e_6.text=''then
    begin
    ShowMessage('NO PENJUALAN BELUM SESUAI');
    end else
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into penjualan values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+e_6.Text+'")');
 zqry1.ExecSQL ;
