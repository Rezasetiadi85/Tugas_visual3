...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('TANGGAL BARANG BELUM DISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into pemesanan values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update pemesanan set id= "'+e_1.Text+'",tgl_pesan="'+e_2.Text+'",nm_barang="'+e_3.Text+'",jumlah_barang="'+e_4.Text+'",barang_id="'+e_5.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from pemesanan where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from pemesanan');
zqry1.Open;
