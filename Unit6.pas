...
if e_1.Text='' then
  begin
    ...
    if e_3.text=''then
    begin
     ShowMessage('JUMLAH BELUM DIISI DENGAN BENAR');
    end else
    if e_4.text=''then
    begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into pembelian values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update pembelian set id= "'+e_1.Text+'",tgl_pembelian="'+e_2.Text+'",jumlah_pembelian="'+e_3.Text+'",total="'+e_4.Text+'" where id'+id+'"');
zqry1. ExecSQL;
